...
wget -O /usr/local/bin/ws "https://raw.githubusercontent.com/Sulastriii/vip/main/sshws/ws"
...
wget -O /usr/local/bin/ws-ovpn "https://raw.githubusercontent.com/Sulastriii/vip/main/sshws/ws"
