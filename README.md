<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Capriola&size=40&duration=4000&pause=450&color=F70069&background=FFFFAA00&center=true&random=false&width=600&height=100&lines=SS VPN AUTOSCRIPT !;Explore the world of features!" /></p>
...
### INSTALL SCRIPT 
<pre><code>apt update -y && apt install -y wget curl && wget -q https://raw.githubusercontent.com/Sulastriii/vip/main/setup.sh && chmod +x setup.sh && ./setup.sh
</code></pre>

### PERINTAH UPDATE 
<pre><code>wget -q https://raw.githubusercontent.com/Sulastriii/vip/main/menu/update.sh && chmod +x update.sh && ./update.sh</code></pre>
