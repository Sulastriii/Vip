...
wget -q -O /usr/local/ddos/ddos.conf https://raw.githubusercontent.com/ilyaevseev/antiddos-script/master/ddos.conf
echo -n '.'
wget -q -O /usr/local/ddos/LICENSE https://raw.githubusercontent.com/ilyaevseev/antiddos-script/master/LICENSE
echo -n '.'
wget -q -O /usr/local/ddos/ignore.ip.list https://raw.githubusercontent.com/ilyaevseev/antiddos-script/master/ignore.ip.list
echo -n '.'
wget -q -O /usr/local/ddos/ddos.sh https://raw.githubusercontent.com/ilyaevseev/antiddos-script/master/ddos.sh
...
echo 'Please send in your comments'
